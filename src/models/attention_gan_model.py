...
class AttentionGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.netG_A = networks.define_G(opt.input_nc, opt.output_nc, opt.ngf, 'resnet_attention', opt.norm,
                                        not opt.no_dropout, opt.init_type, opt.init_gain, self.gpu_ids, use_mask = opt.use_mask)
        self.netG_B = networks.define_G(opt.output_nc, opt.input_nc, opt.ngf, 'resnet_attention', opt.norm,
                                        not opt.no_dropout, opt.init_type, opt.init_gain, self.gpu_ids, use_mask = opt.use_mask)
